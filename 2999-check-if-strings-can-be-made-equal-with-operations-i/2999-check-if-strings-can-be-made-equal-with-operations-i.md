<h1>2999 - Check if Strings Can be Made Equal With Operations I</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/check-if-strings-can-be-made-equal-with-operations-i/">check-if-strings-can-be-made-equal-with-operations-i</a></h2><p>You are given two strings <code>s1</code> and <code>s2</code>, both of length <code>4</code>, consisting of <strong>lowercase</strong> English letters.</p>
