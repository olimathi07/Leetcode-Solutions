<h1>2346 - Largest 3-Same-Digit Number in String</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/largest-3-same-digit-number-in-string/">largest-3-same-digit-number-in-string</a></h2><p>You are given a string <code>num</code> representing a large integer. An integer is <strong>good</strong> if it meets the following conditions:</p>
