<h1>1260 - Day of the Year</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/day-of-the-year/">day-of-the-year</a></h2><p>Given a string <code>date</code> representing a <a href="https://en.wikipedia.org/wiki/Gregorian_calendar" target="_blank">Gregorian calendar</a> date formatted as <code>YYYY-MM-DD</code>, return <em>the day number of the year</em>.</p>
