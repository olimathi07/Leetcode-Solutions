<h1>4177 - Reverse String Prefix</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/reverse-string-prefix/">reverse-string-prefix</a></h2><p>You are given a string <code>s</code> and an integer <code>k</code>.</p>
