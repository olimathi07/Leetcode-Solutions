<h1>3468 - Find the Encrypted String</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/find-the-encrypted-string/">find-the-encrypted-string</a></h2><p>You are given a string <code>s</code> and an integer <code>k</code>. Encrypt the string using the following algorithm:</p>
