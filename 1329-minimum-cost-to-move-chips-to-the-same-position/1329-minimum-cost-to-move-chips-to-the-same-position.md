<h1>1329 - Minimum Cost to Move Chips to The Same Position</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/minimum-cost-to-move-chips-to-the-same-position/">minimum-cost-to-move-chips-to-the-same-position</a></h2><p>We have <code>n</code> chips, where the position of the <code>i<sup>th</sup></code> chip is <code>position[i]</code>.</p>
