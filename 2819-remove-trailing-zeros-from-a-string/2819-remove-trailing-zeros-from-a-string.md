<h1>2819 - Remove Trailing Zeros From a String</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/remove-trailing-zeros-from-a-string/">remove-trailing-zeros-from-a-string</a></h2><p>Given a <strong>positive</strong> integer <code>num</code> represented as a string, return <em>the integer </em><code>num</code><em> without trailing zeros as a string</em>.</p>
