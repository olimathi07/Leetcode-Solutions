<h1>1819 - Construct the Lexicographically Largest Valid Sequence</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/construct-the-lexicographically-largest-valid-sequence/">construct-the-lexicographically-largest-valid-sequence</a></h2><p>Given an integer <code>n</code>, find a sequence with elements in the range <code>[1, n]</code> that satisfies all of the following:</p>
