<h1>1283 - Reformat Date</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/reformat-date/">reformat-date</a></h2><p>Given a <code>date</code> string in the form&nbsp;<code>Day Month Year</code>, where:</p>
