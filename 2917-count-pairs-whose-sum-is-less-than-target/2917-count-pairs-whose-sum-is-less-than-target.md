<h1>2917 - Count Pairs Whose Sum is Less than Target</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/count-pairs-whose-sum-is-less-than-target/">count-pairs-whose-sum-is-less-than-target</a></h2>Given a <strong>0-indexed</strong> integer array <code>nums</code> of length <code>n</code> and an integer <code>target</code>, return <em>the number of pairs</em> <code>(i, j)</code> <em>where</em> <code>0 &lt;= i &lt; j &lt; n</code> <em>and</em> <code>nums[i] + nums[j] &lt; target</code>.
<p>&nbsp;</p>
