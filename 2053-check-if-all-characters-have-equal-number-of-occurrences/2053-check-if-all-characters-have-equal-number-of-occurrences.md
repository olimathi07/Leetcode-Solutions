<h1>2053 - Check if All Characters Have Equal Number of Occurrences</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/check-if-all-characters-have-equal-number-of-occurrences/">check-if-all-characters-have-equal-number-of-occurrences</a></h2><p>Given a string <code>s</code>, return <code>true</code><em> if </em><code>s</code><em> is a <strong>good</strong> string, or </em><code>false</code><em> otherwise</em>.</p>
