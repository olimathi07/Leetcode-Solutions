<h1>2825 - Minimize String Length</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/minimize-string-length/">minimize-string-length</a></h2><p>Given a string <code>s</code>, you have two types of operation:</p>
