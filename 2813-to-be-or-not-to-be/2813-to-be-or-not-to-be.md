<h1>2813 - To Be Or Not To Be</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/to-be-or-not-to-be/">to-be-or-not-to-be</a></h2><p>Write a function&nbsp;<code>expect</code> that helps developers test their code. It should take in any value&nbsp;<code>val</code>&nbsp;and return an object with the following two functions.</p>
