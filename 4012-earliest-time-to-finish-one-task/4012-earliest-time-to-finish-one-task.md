<h1>4012 - Earliest Time to Finish One Task</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/earliest-time-to-finish-one-task/">earliest-time-to-finish-one-task</a></h2><p>You are given a 2D integer array <code>tasks</code> where <code>tasks[i] = [s<sub>i</sub>, t<sub>i</sub>]</code>.</p>
