<h1>3994 - Find The Least Frequent Digit</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/find-the-least-frequent-digit/">find-the-least-frequent-digit</a></h2><p>Given an integer <code>n</code>, find the digit that occurs <strong>least</strong> frequently in its decimal representation. If multiple digits have the same frequency, choose the <strong>smallest</strong> digit.</p>
