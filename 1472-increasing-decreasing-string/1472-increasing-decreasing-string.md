<h1>1472 - Increasing Decreasing String</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/increasing-decreasing-string/">increasing-decreasing-string</a></h2><p>You are given a string <code>s</code>. Reorder the string using the following algorithm:</p>
