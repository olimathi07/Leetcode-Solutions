<h1>3636 - Check Balanced String</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/check-balanced-string/">check-balanced-string</a></h2><p>You are given a string <code>num</code> consisting of only digits. A string of digits is called <b>balanced </b>if the sum of the digits at even indices is equal to the sum of digits at odd indices.</p>
