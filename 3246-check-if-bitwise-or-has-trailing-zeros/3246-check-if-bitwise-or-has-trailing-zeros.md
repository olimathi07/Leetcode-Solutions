<h1>3246 - Check if Bitwise OR Has Trailing Zeros</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/check-if-bitwise-or-has-trailing-zeros/">check-if-bitwise-or-has-trailing-zeros</a></h2><p>You are given an array of <strong>positive</strong> integers <code>nums</code>.</p>
