<h1>3429 - Special Array I</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/special-array-i/">special-array-i</a></h2><p>An array is considered <strong>special</strong> if the <em>parity</em> of every pair of adjacent elements is different. In other words, one element in each pair <strong>must</strong> be even, and the other <strong>must</strong> be odd.</p>
